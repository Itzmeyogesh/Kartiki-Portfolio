...
import kartikiCV from '../assets/Kartiki_Nandeshwar_CV.pdf';
...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center pt-20 pb-12 px-4 sm:px-8"
    >
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col items-start space-y-6 text-left">
          ...
          <p className="text-slate-400 text-base sm:text-lg leading-relaxed max-w-2xl">
            ...
            Results-driven AI & Machine Learning Engineer with hands-on
            experience designing, fine-tuning, and deploying end-to-end
            ML pipelines, deep learning architectures, and NLP models.
            Highly proficient in PyTorch, TensorFlow, Scikit-learn,
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            ...
            <a
              href={kartikiCV}
              download="Kartiki_Nandeshwar_CV.pdf"
        ...
        <div className="lg:col-span-5 flex justify-center">
          ...
          <div className="relative group">
            ...
            <div className="absolute -inset-1 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-3xl blur-xl opacity-50 group-hover:opacity-80 transition duration-500">
            </div>
